...
{
    public partial class CargarEntradaMercaderiaForms : Form
    {
        public CargarEntradaMercaderiaModelo Modelo;
        public CargarEntradaMercaderiaForms()
        {
            InitializeComponent();
        }
        ...
        private void CargarEntradaMercaderiaForms_Load(object sender, EventArgs e)
        {
            Modelo = new();
        }
    }
