...
{
    public partial class ConsultaOrdenEntregaActualizarForm : Form
    {
        public ConsultaOrdenEntregaActualizarFormModelo Modelo;
        public ConsultaOrdenEntregaActualizarForm()
        {
            InitializeComponent();
        }
